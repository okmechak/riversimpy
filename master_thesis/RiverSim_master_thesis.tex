  ...
  \chapter{Validation and geometries of the networks}
    ...
    \section{Geometries of the networks}
      ...
      \subsection{Histograms of branch lengths and Strahler numbers}
        ...
        Here we present on Fig. \ref{laplacian_etas_analysis} length and Strahler number histogram for laplacian river networks shown in Fig. \ref{laplacian_etas}.
        ...
        Next, we present on Fig. \ref{laplacian_big_etas_analysis} length and Strahler number histogram of laplacian river networks on bigger domain shown in Fig. \ref{laplacian_big_etas}.
        ...
        And here we present on Fig. \ref{poisson_etas_analysis} length and Strahler number histogram for poisson rivers networks shown in Fig. \ref{poisson_etas}.
