  ...
  \chapter{The main loop of the program}
    ...
    \begin{mintedbox}{python} 
      ...
      \section{Examples of networks}
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=1\textwidth]{figs/sims/laplacian_big_field_etas.png}        
          \caption{River networks in Laplacian field in a bigger domain with different $\eta$ parameter value ($0$, $1$, and $2$ accordingly) and bifurcation threshold equal to $0.5$.}
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=0.9\textwidth]{figs/sims/poisson_field_etas.png}        
