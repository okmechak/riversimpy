...
\begin{document}
  ...
  \chapter{Validation and geometries of the networks}
    ...
    \section{Convergence of integration and comparison with analytical result}
      ...
      and is used for validation of the $a_1$ series parameter which is shown on Fig. \ref{convergence_new}.

      \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{figs/convergence.jpg}        
    ...
    \section{Geometries of the networks}
      ...
      \subsection{Laplacian field}
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=0.9\textwidth]{figs/sims/laplacian_field_etas.jpg}        
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=0.8\textwidth]{figs/sims/laplacian_big_field_etas.jpg}        
          \caption{River networks in Laplacian field with different $\eta$ parameter value and bifurcation threshold equal to $0.5$.}
      ...
      \subsection{Poisson field}
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=0.75\textwidth]{figs/sims/poisson_field_etas.jpg}        
      ...
      \subsection{Histograms of branch lengths and Strahler numbers}
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=0.9\textwidth]{figs/sims/strahler_and_leght_histogram_for_laplacian_field.jpg}        
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=1\textwidth]{figs/sims/strahler_and_leght_histogram_for_laplacian_big_field.jpg}        
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=0.9\textwidth]{figs/sims/strahler_and_leght_histogram_for_poisson_field.jpg}        
