    ...
    \begin{mintedbox}{python} 
      ...
      \section{Examples of networks}
        ...
        \begin{figure}[H]
          ...
          \caption{Initial region of this simulaiton is rectangle where each corner is the source of the river. After growth of the each river network in Poisson field, you can see that figure is still symmetric.}
        \end{figure}
