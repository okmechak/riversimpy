...
\tytulang{Riversm: river network growth in laplacea field simulation program.}
...
% Słowa kluczowe:
\keywords{fem, fizyka, wody podziemne, rownanie Laplacea, erozja, metody numeryczne}
