...
\begin{document}
  ...
  \chapter{Code validation and river growth simulations}
    ...
    \section{Geometries of the networks}
      ...
      \subsection{Histograms of branch lengths and Strahler numbers}
        ...
        For Fig.\ref{laplacian_big_etas_analysis} Strahler number distribution in the log scale gives an even better fit for power law. Parameter $k$ is in range from $-1.94$ to $-2.26$, and parameter $a$ -- from $112$ to $318$.
        ...
        River networks grown in the Poisson field give the best fits of the power law for Strahler numbers distribution and length distribution. For Strahler number distribution parameter $k$ is in the range from $-1.79$ to $-2.38$. River branch lengths distribution gives the next parameter $k$ after power law fitting values -- from $-1.16$ to $-1.8$.
  ...
  \chapter{Summary}
    ...
    The verification of the Riversim library, an example of a program for calculating the development of the network, simulations result in Laplacian and Poisson fields for different $\eta$, branch length distribution, and Strahler number distribution for different $\eta$. Distributions of branch lengths and Strahler numbers in river networks grown in the Poisson field show a good fit to power law which is shown in Fig.\ref{poisson_etas_analysis}.\par
          ...
          for id_series_param in id_series_params:
              ...
              if m.qGrowth(series_param):
                  ...
                  if m.qBifurcate(series_param, l):
                      ...
                      # and remove a parent from growth evaluation
